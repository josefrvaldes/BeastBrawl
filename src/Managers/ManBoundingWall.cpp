...
ManBoundingWall::ManBoundingWall() {
    ...
    shared_ptr<BoundingWall> p3 = make_shared<BoundingWall>(vec3(-470.f, 20.f, 200.f), false, true);
    shared_ptr<BoundingWall> p4 = make_shared<BoundingWall>(vec3(480.f, 20.f, 200.f), false, false);
