...
void ManGameRules::CreateMayanMap(){
	...
	shared_ptr<GameObject> walls_east_west		= make_shared<GameObject>(default0, default0, default1, "", "maps/mayan/walls_east_west.obj");
		ground.push_back(walls_east_west);
	shared_ptr<GameObject> walls_north_south	= make_shared<GameObject>(default0, default0, default1, "", "maps/mayan/walls_north_south.obj");
		ground.push_back(walls_north_south);
}