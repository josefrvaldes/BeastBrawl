...
public:
    ...
    bool UpdateWallAvoidance(Entity* m_Car,  ManBoundingWall* m_manBoundingWall, ManBoundingOBB* m_manBoundingOBB) const;
    ...
    glm::vec2 WallAvoidance(Entity* m_Car, ManBoundingWall* m_manBoundingWall, ManBoundingOBB* m_manBoundingOBB, const glm::vec2& m_velocityVector) const;
